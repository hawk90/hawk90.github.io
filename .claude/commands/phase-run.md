...
Do not claim a phase or category complete from task titles or baseline tooling alone. A task is complete only when its completion criteria and verification evidence are recorded; a category is complete only when its execution-graph closure criteria and all AP dispositions are recorded.
