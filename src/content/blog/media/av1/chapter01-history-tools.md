...
- **Intra 예측**: 같은 프레임 내 이웃 픽셀 참조 → Ch 8에서 상세히 다룸
- **Inter 예측**: 이전/이후 프레임 참조 → Ch 12에서 상세히 다룸
...
- 결과: 소수의 큰 계수 + 다수의 0에 가까운 계수 → Ch 9에서 상세히 다룸
...
- AV1은 산술 코딩(Arithmetic Coding) 사용 → Ch 7에서 상세히 다룸
