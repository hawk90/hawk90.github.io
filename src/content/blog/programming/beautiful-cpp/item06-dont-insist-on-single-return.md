...
- [항목 7: 지저분한 struct 캡슐화](/blog/programming/beautiful-cpp/item07-encapsulate-messy-structs) — RAII 래퍼 패턴
- [항목 17: 전역 상태/에러 처리](/blog/programming/beautiful-cpp/item17-avoid-global-state-error-handling) — 에러 처리 모델
- [항목 30: RAII로 누수 방지](/blog/programming/beautiful-cpp/item30-use-raii-to-prevent-leaks) — RAII의 기반
