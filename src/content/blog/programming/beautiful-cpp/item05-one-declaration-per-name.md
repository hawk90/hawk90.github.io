...
- [항목 3: 기본 멤버 초기화자](/blog/programming/beautiful-cpp/item03-use-default-member-initializers) — 멤버 선언 패턴
- [항목 19: 다중 반환은 struct로](/blog/programming/beautiful-cpp/item19-return-struct-for-multiple-outputs) — 여러 값 묶음
- [항목 28: 사용 전 초기화](/blog/programming/beautiful-cpp/item28-dont-declare-before-init) — 초기화 누락 함정
