...
- [항목 7: 지저분한 struct 캡슐화](/blog/programming/beautiful-cpp/item07-encapsulate-messy-structs) — C API의 안쪽 래핑
- [항목 13: 원시 포인터로 소유권 이전 X](/blog/programming/beautiful-cpp/item13-never-transfer-ownership-via-raw-pointer) — 단, ABI 경계는 예외
- [항목 17: 전역 상태 / 에러](/blog/programming/beautiful-cpp/item17-avoid-global-state-error-handling) — 반환 코드 패턴
