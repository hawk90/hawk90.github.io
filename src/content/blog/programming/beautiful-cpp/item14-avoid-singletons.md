...
- [항목 11: 명시적 공유 최소화](/blog/programming/beautiful-cpp/item11-minimize-explicit-data-sharing) — 전역 가변 상태의 문제
- [항목 17: 전역 상태 에러 처리](/blog/programming/beautiful-cpp/item17-avoid-global-state-error-handling) — 전역 상태의 다른 형태
- [Effective C++ 항목 4: 객체 초기화](/blog/programming/effective-cpp/item04-make-sure-objects-are-initialized-before-use) — Meyers' singleton
