...
- [항목 8: 인자 적게 유지](/blog/programming/beautiful-cpp/item08-keep-function-arguments-minimal) — 입력에도 같은 원리
- [항목 17: 에러 처리](/blog/programming/beautiful-cpp/item17-avoid-global-state-error-handling) — optional/expected
- [항목 5: 한 선언 한 이름](/blog/programming/beautiful-cpp/item05-one-declaration-per-name) — 변수 선언 일반
