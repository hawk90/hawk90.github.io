...
- [항목 7: 지저분한 struct 캡슐화](/blog/programming/beautiful-cpp/item07-encapsulate-messy-structs) — C API 위반 캡슐화
- [항목 9: C ABI 경계](/blog/programming/beautiful-cpp/item09-use-c-subset-for-cross-compiler-abi) — ABI 위반 격리
- [항목 16: const 캐스트 X](/blog/programming/beautiful-cpp/item16-dont-cast-away-const) — const_cast 사용
