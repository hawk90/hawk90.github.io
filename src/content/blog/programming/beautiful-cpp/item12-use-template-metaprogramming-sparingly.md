...
- [항목 22: constexpr 컴파일 타임](/blog/programming/beautiful-cpp/item22-use-constexpr-for-compile-time) — 모던 컴파일 타임 도구
- [항목 23: 추상화에 템플릿 활용](/blog/programming/beautiful-cpp/item23-use-templates-for-abstraction) — 적절한 템플릿 사용
- [항목 24: concept으로 템플릿 제약](/blog/programming/beautiful-cpp/item24-specify-concepts-for-template-args) — concepts 활용
