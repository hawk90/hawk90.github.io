...
- [항목 5: 한 선언 한 이름](/blog/programming/beautiful-cpp/item05-one-declaration-per-name) — 헤더 위생 일반
- [항목 9: C ABI 경계](/blog/programming/beautiful-cpp/item09-use-c-subset-for-cross-compiler-abi) — 헤더의 또 다른 신중함
- [항목 12: TMP 최소화](/blog/programming/beautiful-cpp/item12-use-template-metaprogramming-sparingly) — 헤더 컴파일 시간
