...
- [항목 12: TMP 최소화](/blog/programming/beautiful-cpp/item12-use-template-metaprogramming-sparingly) — constexpr가 TMP 대체
- [항목 23: 템플릿 추상화](/blog/programming/beautiful-cpp/item23-use-templates-for-abstraction) — 컴파일 타임 일반화
- [Effective C++ 항목 2: #define보다 const](/blog/programming/effective-cpp/item02-prefer-consts-enums-and-inlines-to-defines) — 매크로 대체
