...
- [항목 19: 다중 반환은 struct로](/blog/programming/beautiful-cpp/item19-return-struct-for-multiple-outputs) — 반환에도 같은 원리
- [항목 20: enum class 선호](/blog/programming/beautiful-cpp/item20-prefer-enum-class) — bool 매개변수 대체
