...
- [항목 3: 기본 멤버 초기화자](/blog/programming/beautiful-cpp/item03-use-default-member-initializers) — struct 패턴과 결합
- [항목 7: 지저분한 struct 캡슐화](/blog/programming/beautiful-cpp/item07-encapsulate-messy-structs) — struct가 적절한 경우
- [항목 27: 규칙 위반 캡슐화](/blog/programming/beautiful-cpp/item27-encapsulate-rule-violations) — 캡슐화의 다른 측면
