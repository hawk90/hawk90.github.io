...
- [항목 5: 한 선언 한 이름](/blog/programming/beautiful-cpp/item05-one-declaration-per-name) — 변수 선언 규칙
- [항목 6: 단일 반환 X](/blog/programming/beautiful-cpp/item06-dont-insist-on-single-return) — 이른 반환과 스코프
- [항목 28: 사용 전 초기화](/blog/programming/beautiful-cpp/item28-dont-declare-before-init) — 초기화 일반
