...
- [항목 7: 지저분한 struct 캡슐화](/blog/programming/beautiful-cpp/item07-encapsulate-messy-structs) — C API의 RAII 래핑
- [항목 11: 명시적 공유 최소화](/blog/programming/beautiful-cpp/item11-minimize-explicit-data-sharing) — shared_ptr의 신중한 사용
