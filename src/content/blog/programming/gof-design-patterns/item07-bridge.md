...
- **[Adapter (item 6)](/blog/programming/gof-design-patterns/item06-adapter)** — Adapter는 사후 호환, Bridge는 사전 분리
- **[Strategy (item 21)](/blog/programming/gof-design-patterns/item21-strategy)** — 구조 거의 동일. Bridge는 클래스 계층 분리, Strategy는 알고리즘 교체에 집중
- **[Abstract Factory (item 1)](/blog/programming/gof-design-patterns/item01-abstract-factory)** — Bridge의 ConcreteImplementor 군을 Abstract Factory로 생성
