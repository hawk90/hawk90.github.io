...
> ⚠️ **명확한 역연산이 있는 동작**이라면 [Command](/blog/programming/gof-design-patterns/item14-command) 패턴이 더 효율적.
...
- **[Iterator (item 16)](/blog/programming/gof-design-patterns/item16-iterator)** — Iterator의 위치를 Memento로 저장 (외부 보관)
- **[Prototype (item 4)](/blog/programming/gof-design-patterns/item04-prototype)** — 둘 다 객체 상태 보존. Prototype은 새 인스턴스, Memento는 기존 인스턴스 복원
