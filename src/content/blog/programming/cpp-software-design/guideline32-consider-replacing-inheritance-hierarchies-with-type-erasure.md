...
virtual 호출 — hot path에선 측정 필요. 다음 가이드라인 — [최적화](/blog/programming/cpp-software-design/guideline33-be-aware-of-the-optimization-potential-of-type-erasure).
...
- [가이드라인 31: External Polymorphism](/blog/programming/cpp-software-design/guideline31-use-external-polymorphism-for-nonintrusive-runtime-polymorphism) — Type Erasure의 토대
...
- [가이드라인 22: 값 의미론](/blog/programming/cpp-software-design/guideline22-prefer-value-semantics-over-reference-semantics) — 동기
