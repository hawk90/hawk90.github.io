...
- [가이드라인 1: 디자인의 중요성](/blog/programming/cpp-software-design/guideline01-understand-the-importance-of-software-design) — 의존성 관리의 본질
- [가이드라인 2: 변화를 위한 디자인](/blog/programming/cpp-software-design/guideline02-design-for-change) — DIP의 깊은 적용
- [가이드라인 10: 아키텍처 문서](/blog/programming/cpp-software-design/guideline10-consider-creating-an-architectural-document) — 소유권 명시
- [Beautiful C++ 항목 14: 싱글톤 피하기](/blog/programming/beautiful-cpp/item14-avoid-singletons) — 의존성 주입
