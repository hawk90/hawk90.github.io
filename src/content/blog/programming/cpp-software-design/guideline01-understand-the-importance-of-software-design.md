...
- [가이드라인 2: 변화를 위한 디자인](/blog/programming/cpp-software-design/guideline02-design-for-change) — 변경 가능성의 구체적 방법
- [가이드라인 3: 인터페이스 분리](/blog/programming/cpp-software-design/guideline03-separate-interfaces-to-avoid-artificial-coupling) — 인터페이스로 결합도 관리
- [Effective C++ 항목 23: 비-멤버 비-friend](/blog/programming/effective-cpp/item23-prefer-non-member-non-friend-functions-to-member-functions) — 결합도와 캡슐화
- [Beautiful C++ 항목 14: 싱글톤 피하기](/blog/programming/beautiful-cpp/item14-avoid-singletons) — 숨겨진 의존성
