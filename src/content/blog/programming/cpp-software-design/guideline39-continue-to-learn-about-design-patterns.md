...
자세 — [GoF 시리즈](/blog/programming/gof-design-patterns/) 23 패턴 전체.
...
- *Effective Modern C++* (Meyers, 2014) — [시리즈 링크](/blog/programming/effective-modern-cpp/)
- *Effective C++ 3rd* (Meyers, 2005) — [시리즈 링크](/blog/programming/effective-cpp/)
- *Beautiful C++* (Vandevoorde, 2020) — [시리즈 링크](/blog/programming/beautiful-cpp/)
...
- [GoF 디자인 패턴 시리즈](/blog/programming/gof-design-patterns/) — 23 패턴 완전 정리
- [Effective C++ 시리즈](/blog/programming/effective-cpp/) — Meyers 클래식
- [Effective Modern C++ 시리즈](/blog/programming/effective-modern-cpp/) — C++11/14
- [Beautiful C++ 시리즈](/blog/programming/beautiful-cpp/) — 모던 가이드라인
- [가이드라인 1: Software Design의 중요성](/blog/programming/cpp-software-design/guideline01-understand-the-importance-of-software-design) — 시리즈 시작점
