...
- [가이드라인 11: 명시적 공유 최소화](/blog/programming/beautiful-cpp/item11-minimize-explicit-data-sharing) — 라이프타임
- [가이드라인 21: Command](/blog/programming/cpp-software-design/guideline21-use-command-to-isolate-what-things-are-done) — 함수 객체
- [GoF Observer](/blog/programming/gof-design-patterns/item18-observer) — 원본
- [Beautiful C++ 항목 30: RAII](/blog/programming/beautiful-cpp/item30-use-raii-to-prevent-leaks) — Subscription RAII
