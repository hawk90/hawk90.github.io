...
- [가이드라인 3: 인터페이스 분리](/blog/programming/cpp-software-design/guideline03-separate-interfaces-to-avoid-artificial-coupling) — ISP와 LSP의 자매
- [가이드라인 7: base vs concept](/blog/programming/cpp-software-design/guideline07-understand-the-similarities-between-base-classes-and-concepts) — concepts에도 LSP
- [Effective C++ 항목 32: public 상속 = is-a](/blog/programming/effective-cpp/item32-make-sure-public-inheritance-models-is-a) — LSP의 EC++ 버전
- [Effective C++ 항목 36: non-virtual 재정의 X](/blog/programming/effective-cpp/item36-never-redefine-an-inherited-non-virtual-function) — LSP 위반의 한 형태
