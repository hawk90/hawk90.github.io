...
- [가이드라인 5: 확장을 위한 디자인](/blog/programming/cpp-software-design/guideline05-design-for-extension) — Strategy로 OCP
- [가이드라인 20: composition > inheritance](/blog/programming/cpp-software-design/guideline20-favor-composition-over-inheritance) — Strategy의 큰 원칙
- [가이드라인 22: value semantics](/blog/programming/cpp-software-design/guideline22-prefer-value-semantics-over-reference-semantics) — Strategy 가치
- [가이드라인 23: value-based Strategy](/blog/programming/cpp-software-design/guideline23-prefer-a-value-based-implementation-of-strategy-and-command) — std::variant 구현
- [GoF Strategy](/blog/programming/gof-design-patterns/item19-strategy) — 원본
