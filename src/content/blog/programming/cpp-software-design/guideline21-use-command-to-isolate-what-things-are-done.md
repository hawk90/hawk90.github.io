...
- [가이드라인 19: Strategy](/blog/programming/cpp-software-design/guideline19-use-strategy-to-isolate-how-things-are-done) — "어떻게" 격리
- [가이드라인 22: value semantics](/blog/programming/cpp-software-design/guideline22-prefer-value-semantics-over-reference-semantics) — Command의 가치
- [가이드라인 23: value-based Command](/blog/programming/cpp-software-design/guideline23-prefer-a-value-based-implementation-of-strategy-and-command) — variant 구현
- [GoF Command](/blog/programming/gof-design-patterns/item17-command) — 원본
