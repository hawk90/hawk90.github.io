...
### 5. *Flow 중 강제 break*
Pomodoro에 너무 충실 → flow 깨짐. *상황 판단* 필요.
...
원격팀 — 막히면 *문서 작성, code review* 등 *다른 종류*의 작업. 휴식과 진척 모두.
...
추상 — 코드 성능 무관. *인간 성능*에 직접 영향. 휴식 *없이* 일한 시간 *>>* 휴식 후 *효율적 시간*.
