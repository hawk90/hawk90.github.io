...
slug: "programming/engineering/tdd-patterns/pattern24-triangulate"
...
> 두 번째 예제를 추가해 구현을 일반화하도록 강제. GPS 삼각측량처럼 두 점으로 위치 특정.

## 동기

[Fake It](/blog/programming/engineering/tdd-patterns/pattern23-fake-it)으로 상수를 반환. 언제 진짜 구현으로 바꿔야 하나?
...
triangulate가 예상치 못한 규칙을 예제로 드러냄.
