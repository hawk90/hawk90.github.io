...
slug: "programming/engineering/tdd-patterns/pattern44-reconcile-differences"
...
한 번에 합치기는 위험 (테스트 깨질 위험). **Reconcile Differences**는 작은 단계로 동일화 → 마지막에 통합.
