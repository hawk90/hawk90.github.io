...
slug: "programming/engineering/tdd-patterns/pattern49-extract-interface"
...
순수 로직까지 → boilerplate. 외부 경계만.

### 2. Interface가 1대1 매핑

구현이 항상 1개면 interface 가치 작음. 진짜 교체 가능해야.
...
domain이 port에만 의존, adapter 교체 가능하다.
...
interface call은 vtable lookup — JIT inline. 거의 무관. Rust trait object는 약간 비용 (dynamic dispatch) — generic으로 static dispatch 가능하다.
