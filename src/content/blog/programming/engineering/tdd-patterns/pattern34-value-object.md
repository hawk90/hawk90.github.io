...
> 값으로 비교하는 불변 객체. Beck의 Money 예제의 핵심, DDD Value Object와 동일.
...
**Value Object**는 값으로 비교. identity가 아닌 content가 본질.
...
`with_postcode` 같은 변경은 새 instance.
...
- 작은 객체는 heap 할당 부담 < concurrency 안전성.
