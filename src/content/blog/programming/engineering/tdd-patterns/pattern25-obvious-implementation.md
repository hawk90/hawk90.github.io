...
slug: "programming/engineering/tdd-patterns/pattern25-obvious-implementation"
...
모든 것을 Fake It으로 시작할 필요 없다. 구현이 뻔할 때가 있다.
...
표준 라이브러리 호출 시 가정만 — 실제 동작 다름. [Learning Test](/blog/programming/engineering/tdd-patterns/pattern11-learning-test) 보완.
...
IDE의 template으로 standard pattern 즉시 생성. boilerplate obvious.
...
추상 — 코드 성능 무관. 개발 속도에 큰 영향. Obvious 활용도 높을수록 throughput ↑. 단 과신은 역효과.
