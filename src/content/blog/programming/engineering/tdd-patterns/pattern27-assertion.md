...
slug: "programming/engineering/tdd-patterns/pattern27-assertion"
...
> 테스트의 기대값을 boolean assertion으로 표현하고, 실패 시 유용한 메시지 제공. assertion이 test의 의도.
...
assertion은 test 본문의 비중. 빠른 검증이 fast cycle. Deep equality는 큰 객체에서 느릴 수 있음 — 대안: hash, summary.
