...
> 알고리즘 골격은 부모 class에, 가변 단계는 자식이 구현. xUnit의 test 실행 순서가 대표.

## 동기

여러 class가 비슷한 알고리즘인데 일부 단계만 다름:
...
xUnit의 test 실행 순서가 Template Method.

### 신호

- 비슷한 알고리즘이 여러 class에 중복.
- 일부 단계가 고정, 나머지는 가변.
- Pull Up Method의 결과 자연.
