...
slug: "programming/engineering/tdd-patterns/pattern37-pluggable-object"
...
**Pluggable Object**는 조건문을 객체 교체로.
...
Pluggable Object는 GoF Strategy 패턴의 정신.
...
class가 함수 하나만 — 그냥 함수 전달이 단순하다.

### 2. 모든 분기를 Pluggable

간단한 한 곳 분기까지 → boilerplate. 진짜 반복 + 변경만.

### 3. Tight coupling

Strategy가 호스트 class에 강결합 → 진짜 plug-in 아님. interface 명확하다.
