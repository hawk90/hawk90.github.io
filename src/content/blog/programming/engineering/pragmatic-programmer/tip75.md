...
요청 뒤의 이유를 이해한다. 짧은 대화로 진짜 요구를 찾는다.
...
- 개발자 — "10만 건을 실시간으로 보여주면 페이지가 느려질 수 있어요. 대신 최근 100건을 보여주고, 검색으로 나머지를 찾게 하면 어떨까요?"
- 고객 — "그게 낫겠네요"
...
| Sprint | 목표 |
|--------|------|
| 1 | 주문을 생성할 수 있다 → 구현 후 피드백 |
| 2 | 주문에 할인을 적용할 수 있다 → 구현 후 피드백 |
| 3 | 복잡한 프로모션 규칙을 지원한다 → 구현 후 피드백 |
