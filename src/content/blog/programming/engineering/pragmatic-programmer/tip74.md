...
도메인 전문가: "배송 전까지요"
개발자: "배송 전이란 정확히 언제죠?"
도메인 전문가: "상품이 창고를 떠나기 전... 아, 부분 배송이면 복잡해요"
```
...
```text
버전 1.0: "사용자는 상품을 검색할 수 있다"
버전 1.1: "사용자는 카테고리별로 상품을 검색할 수 있다"
버전 1.2: "사용자는 가격 범위로 필터링할 수 있다"
...
```
