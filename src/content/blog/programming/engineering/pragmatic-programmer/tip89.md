...
일찍 발견하면 수정도 쉽다. 맥락이 아직 머릿속에 있기 때문이다. 테스트 피라미드와 테스트 종류별 특성은 [Tip 69: Test Your Software, or Your Users Will](/blog/programming/engineering/pragmatic-programmer/tip69)에서 자세히 다룬다.
...
**단위 테스트:** 함수나 클래스 단위를 격리해서 테스트한다. 외부 의존성은 모킹하고, 밀리초 단위로 빠르게 실행된다.
...
**통합 테스트:** 여러 컴포넌트의 상호작용을 테스트한다. 실제 DB나 API를 사용하며, 초 단위로 실행된다.
...
**E2E 테스트:** 사용자 시나리오 전체를 테스트한다. 실제 환경과 유사하게 구성하며, 분 단위로 느리게 실행된다.
...
- [Tip 69: Test Your Software, or Your Users Will](/blog/programming/engineering/pragmatic-programmer/tip69) — 테스트 피라미드와 테스트 종류
