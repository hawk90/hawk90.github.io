...
```text
Day 1 AM: 스케치/와이어프레임 공유
→ "이런 느낌이에요?"
→ 피드백: "검색 필드가 더 눈에 띄어야 해요"
...
```text
3개월 후 발견: "완전히 다시 해야 해요" (큰 비용)
1주 후 발견: "방향을 바꿔야 해요" (작은 비용)
1일 후 발견: "이 부분 수정하면 돼요" (최소 비용)
```
