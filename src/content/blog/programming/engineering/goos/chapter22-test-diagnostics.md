...
테스트가 실패했을 때 **왜 실패했는지** 즉시 알 수 있어야 한다. 좋은 진단 메시지는 디버깅 시간을 크게 줄인다. 반대로 메시지가 빈약하면, 실패한 테스트 하나를 이해하기 위해 디버거를 띄우고 print 문을 심는 시간이 더 길어진다. 이 장에서는 assertion 메시지, 자동 컨텍스트 수집, 상태 덤프까지 진단 가능한 실패를 만드는 기법을 본다.

![Diagnostic Flow](/images/blog/goos/diagrams/ch22-diagnostic-flow.svg)
...
- [Ch 21: Test Flexibility](/blog/programming/engineering/goos/chapter21-test-flexibility) — 이전 장
- [Ch 23-27: Advanced — Persistence / Threads / Async](/blog/programming/engineering/goos/chapter23-persistence) — 다음 장
- [Khorikov Ch 7: 단위 테스트 리팩토링](/blog/programming/engineering/khorikov-unit-testing/chapter07-refactoring) — 진단 가능한 실패를 만드는 구조
