...
│                                                             │
│   2. 내 도메인 언어 사용                                    │
│      - 외부: connection.send_to(jid, message)               │
│      - 내부: auction.bid(amount)                            │
│      - 도메인 개념으로 번역                                  │
│                                                             │
│   3. 에러 번역                                              │
│      - 외부: XmppException, NetworkError                    │
│      - 내부: AuctionError, ConnectionLost                   │
│      - 내 예외 타입으로 변환                                 │
│                                                             │
└─────────────────────────────────────────────────────────────┘
```
...
│                                                             │
│   외부 시스템의 개념이 내 도메인을 "오염"시키지 않게 보호    │
│                                                             │
│   ┌──────────────────────────────────────────────────────┐ │
│   │                   My Domain                           │ │
│   │  ┌─────────┐  ┌─────────┐  ┌─────────┐              │ │
│   │  │ Auction │  │ Sniper  │  │ Bidding │              │ │
│   │  │         │  │         │  │         │              │ │
│   │  └─────────┘  └─────────┘  └─────────┘              │ │
│   │           (내 도메인 언어)                            │ │
│   └──────────────────────────────────────────────────────┘ │
