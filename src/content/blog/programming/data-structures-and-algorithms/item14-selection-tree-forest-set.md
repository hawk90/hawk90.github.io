...
→ **path compression + union by rank** 최적화 필요. 자세히는 [item 31](/blog/programming/data-structures-and-algorithms/item31-disjoint-set-detail) (Part B의 Union-Find 깊이 보기).
...
- [그래프 표현 + DFS/BFS](/blog/programming/data-structures-and-algorithms/item15-graph-traversal)
