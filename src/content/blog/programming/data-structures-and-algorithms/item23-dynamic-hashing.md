...
[item 22의 정적 해싱](/blog/programming/data-structures-and-algorithms/item22-static-hashing)은 데이터가 늘면 **전체 재해싱** 필요 — O(n) 비용. 메모리에선 amortized O(1)이지만 **디스크에서 수 GB 재해싱은 endurance·시간 모두 부담**.
...
- [Min-Max Heap, Deap](/blog/programming/data-structures-and-algorithms/item24-min-max-heap-deap)
