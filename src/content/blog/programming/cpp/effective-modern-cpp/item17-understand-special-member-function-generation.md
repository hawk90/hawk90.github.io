...
이게 [항목 26 (보편 참조 오버로딩 함정)](/blog/programming/cpp/effective-modern-cpp/item26-avoid-overloading-on-universal-references)의 토대.
...
→ 표준 컨테이너가 move를 사용 ([항목 14 참고](/blog/programming/cpp/effective-modern-cpp/item14-declare-functions-noexcept-if-they-wont-emit-exceptions)).
