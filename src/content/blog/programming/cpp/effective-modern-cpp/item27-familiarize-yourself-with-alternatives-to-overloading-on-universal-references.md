...
[항목 26](/blog/programming/cpp/effective-modern-cpp/item26-avoid-overloading-on-universal-references)에서 본 함정 — 보편 참조와 다른 오버로드 함께 두기. 이 항목은 그 함정을 피하면서도 보편 참조의 효율을 누리는 **다섯 가지 대안**.
...
자세한 분석은 [항목 41](/blog/programming/cpp/effective-modern-cpp/item41-consider-pass-by-value-for-copyable-cheap-to-move-always-copied-params).
...
- **실제로 forward 못 되는 케이스** ([항목 30](/blog/programming/cpp/effective-modern-cpp/item30-familiarize-yourself-with-perfect-forwarding-failure-cases))
