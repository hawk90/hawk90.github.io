...
- 템플릿 — **헤더에 노출** (구현 분리 X)
- 컴파일 시간 증가
- 오버로드 함정 ([항목 26](/blog/programming/cpp/effective-modern-cpp/item26-avoid-overloading-on-universal-references), [27](/blog/programming/cpp/effective-modern-cpp/item27-familiarize-yourself-with-alternatives-to-overloading-on-universal-references))
