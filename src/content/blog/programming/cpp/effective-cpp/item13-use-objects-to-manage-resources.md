...
slug: "programming/cpp/effective-cpp/item13-use-objects-to-manage-resources"
...
RAII는 두 가지 원리 위에 서 있다.

**1. 자원은 획득 즉시 객체에 위임된다.**

자원을 얻는 순간 그 자원을 관리하는 객체가 만들어집니다 — 그래서 "**자원 획득 == 객체 초기화**". 자원을 들고 다닐 raw 변수가 따로 존재하지 않는다.
