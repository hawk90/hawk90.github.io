...
slug: "programming/cpp/beautiful-cpp/item28-dont-declare-before-init"
date: 2026-05-05T04:00:00
description: "선언과 초기화 분리는 C 시절의 잔재 — 미초기화 변수 = UB. 사용 시점 선언 + auto가 정답."
tags: [cpp, Initialization, code-style]
series: "Beautiful C++"
seriesOrder: 28
draft: true
...
- [항목 3: 기본 멤버 초기화자](/blog/programming/cpp/beautiful-cpp/item03-use-default-member-initializers) — 멤버 초기화
- [항목 15: ctor not memset](/blog/programming/cpp/beautiful-cpp/item15-use-constructors-not-memset-memcpy) — 객체 초기화
- [항목 21: 스코프 작게](/blog/programming/cpp/beautiful-cpp/item21-keep-scope-small) — 좁은 스코프
