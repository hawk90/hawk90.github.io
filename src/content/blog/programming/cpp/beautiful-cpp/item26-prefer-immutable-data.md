...
slug: "programming/cpp/beautiful-cpp/item26-prefer-immutable-data"
...
**불변 데이터**는 이 모든 질문에 답을 준다 — "변하지 않는다". 결과:
- 추론 단순
- 멀티스레드에서 락 없이 공유 가능
- 테스트가 쉬움 (상태 변화 없음)
- 캐시·메모이제이션 자연스러움
...
- [항목 11: 명시적 공유 최소화](/blog/programming/cpp/beautiful-cpp/item11-minimize-explicit-data-sharing) — 불변이 공유의 답
- [항목 16: const 캐스트 X](/blog/programming/cpp/beautiful-cpp/item16-dont-cast-away-const) — const 약속
- [항목 22: constexpr](/blog/programming/cpp/beautiful-cpp/item22-use-constexpr-for-compile-time) — 컴파일 타임 불변
