...
- [항목 8: 인자 적게 유지](/blog/programming/cpp/beautiful-cpp/item08-keep-function-arguments-minimal) — bool 매개변수 → enum class
- [항목 25: 정적 타입 안전성](/blog/programming/cpp/beautiful-cpp/item25-static-type-safety) — 강 타입 패턴
- [Effective Modern C++ 항목 10: scoped enums 선호](/blog/programming/cpp/effective-modern-cpp/item10-prefer-scoped-enums-to-unscoped-enums) — 같은 주제 심층
