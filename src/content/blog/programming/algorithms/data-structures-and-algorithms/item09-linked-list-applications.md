...
[item05](/blog/programming/algorithms/data-structures-and-algorithms/item05-structures-polynomials-sparse-matrix)에서 배열로 다항식 봤음. 연결 리스트로는 **항이 동적으로 추가/삭제** 자유.
...
- [이진 트리 — 정의·순회](/blog/programming/algorithms/data-structures-and-algorithms/item10-binary-tree-traversal)
