...
[item02](/blog/programming/effective-modern-cpp/item02-understand-auto-type-deduction)에서 다룸 — `auto x{1}`이 C++17부터 `int`로 추론.
...
- [항목 2: `auto` 추론](/blog/programming/effective-modern-cpp/item02-understand-auto-type-deduction) — `auto x{1}` 케이스
- [항목 21: `make_unique`/`make_shared` 선호](/blog/programming/effective-modern-cpp/item21-prefer-make-unique-and-make-shared-to-direct-new) — `()` 사용 이유
