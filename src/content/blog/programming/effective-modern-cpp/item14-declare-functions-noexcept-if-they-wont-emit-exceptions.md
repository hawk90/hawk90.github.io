...
- [항목 17: 특수 멤버 자동 생성](/blog/programming/effective-modern-cpp/item17-understand-special-member-function-generation) — move 자동 생성과 noexcept
- [항목 29: move 가정](/blog/programming/effective-modern-cpp/item29-assume-move-operations-are-not-present-not-cheap-and-not-used) — noexcept 없으면 move 안 쓰임
