...
[항목 31](/blog/programming/effective-modern-cpp/item31-avoid-default-capture-modes)에서 본 패턴:
...
단점:
- `bind`의 단점 ([항목 34](/blog/programming/effective-modern-cpp/item34-prefer-lambdas-to-std-bind)) — 가독성, 디버깅
...
- [항목 31: 기본 캡처 모드](/blog/programming/effective-modern-cpp/item31-avoid-default-capture-modes)
