...
`make_shared`/`make_unique`는 인자를 forward — 그러나 보편 참조라 `{}` 추론 실패 ([항목 30](/blog/programming/effective-modern-cpp/item30-familiarize-yourself-with-perfect-forwarding-failure-cases)).
...
- [항목 19: shared_ptr](/blog/programming/effective-modern-cpp/item19-use-shared-ptr-for-shared-ownership)
