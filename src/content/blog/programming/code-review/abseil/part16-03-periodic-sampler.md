...
Abseil Code Review 시리즈는 여기까지다. Folly 시리즈에서 대응 도구를 비교하거나 EMC++ 시리즈에서 함수 객체·자원 관리의 표준을 더 깊이 본다. Google C++ Style Guide ([embedded/standards](/blog/embedded/standards/google-cpp/chapter01-header-files))에서 사내 코딩 규약과의 연결을 확인할 수 있다.
...
- [Folly Part 9-03 — sampling](/blog/programming/code-review/folly/part9-03-sampling) — Meta 대응
