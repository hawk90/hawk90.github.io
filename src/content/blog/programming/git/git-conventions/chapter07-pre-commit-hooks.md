...
slug: "programming/git/git-conventions/chapter07-pre-commit-hooks"
...
- husky (Node.js) — 표준
- lefthook (Go) — 빠름 / 병렬
- pre-commit (Python) — 다언어
- 비교 — 속도 / 의존성 / 설정 단순함
- 자주 쓰는 작업 — formatter / linter / tests / typecheck / commitlint
- bypass — --no-verify (사용은 신중히)
- 서버 hook과 협력
