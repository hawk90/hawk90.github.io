...
> 좋은 분류는 **핵심 추상화**를 찾는 것입니다. 문제 도메인의 어휘에서 **명사를 추출**하고, 책임을 할당하며, **반복적으로 정제**합니다.
...
**예**: "고객이 상품을 장바구니에 담고 주문합니다" → Customer, Product, Cart, Order

**실제 적용 예**:

> 요구사항: "도서관 시스템에서 회원은 책을 대출하고 반납합니다. 사서는 신규 도서를 등록하고, 연체 회원에게 알림을 보냅니다. 회원은 책을 예약할 수 있고, 대출 기한은 2주입니다."
...
Chapter 5에서는 **표기법**을 다룹니다. UML로 클래스, 시퀀스, 상태 다이어그램을 그리는 방법.
