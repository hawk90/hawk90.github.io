...
> 객체지향 개발은 **반복적(iterative)**이고 **점진적(incremental)**입니다. **마이크로 프로세스**가 일상 활동을, **매크로 프로세스**가 프로젝트 전체를 안내합니다.
...
Chapter 7에서는 **실무**를 다룹니다. 팀 관리, 릴리스 계획, 재사용, 품질 보증 등 프로젝트 성공을 위한 실무적 고려사항.
