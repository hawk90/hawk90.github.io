...
slug: "programming/design/uml/item27-collaborations"
...
> 💡 용어 주의 — UML 2.5.1에서 **`Collaboration`(협력)** 은 *구조적 분류자* (역할들의 묶음). 반면 UML 1.x의 *"Collaboration Diagram"*은 UML 2.0에서 **"Communication Diagram"(커뮤니케이션 다이어그램)** 으로 개명되었습니다. 이 챕터는 **전자**(구조 추상)를 다룹니다.
