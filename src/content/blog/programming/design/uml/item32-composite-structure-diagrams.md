...
```text
[engine : Engine]──○ IFuel       (engine은 IFuel을 *요구*)
                  ⊃─ IThrottle   (engine은 IThrottle을 *제공*)
```
...
```text
[ECU]
 ├ part cpu : Cortex-M7   ⊃─ IBus ──● [bus : AXI]
 ├ part can : CANController  ⊃─ IBus ──●
 └ part adc : ADC          ⊃─ IBus ──●
```
