...
<img src="/images/blog/uml/diagrams/item10-n-ary-association.svg" alt="N-ary 연관 — Project + Student + Mentor" style="max-width:100%; background:white; padding:8px; border-radius:6px;" />
...
<img src="/images/blog/uml/diagrams/item10-association-class.svg" alt="연관 클래스 — Person·Company 사이의 Job" style="max-width:100%; background:white; padding:8px; border-radius:6px;" />
...
<img src="/images/blog/uml/diagrams/item10-generalization-sets.svg" alt="Generalization Sets — age-group과 species 두 축으로 분류" style="max-width:100%; background:white; padding:8px; border-radius:6px;" />
