...
slug: "programming/design/gof-design-patterns/item24-pattern-relationships-overview"
...
→ 같은 도식인데 *어디서 변화가 일어나는가*가 패턴을 가릅니다.
...
<p class="intent">관련된 객체 군을 한 번에 — 클라이언트는 어떤 OS·테마인지 알 필요가 없습니다.</p>
...
<p class="intent">요청을 객체로 — undo/redo, 큐, 매크로, 로깅이 가능해집니다.</p>
...
→ "패턴은 사라지지 않는다 — 다만 *언어 기능*으로 흡수됩니다."
