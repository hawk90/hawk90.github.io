...
<img src="/images/blog/gof/diagrams/item17-mediator-seq.svg" alt="Mediator 시퀀스 — Colleague들이 Mediator를 통해서만 통신" style="max-width:100%; background:white; padding:8px; border-radius:6px;" />
