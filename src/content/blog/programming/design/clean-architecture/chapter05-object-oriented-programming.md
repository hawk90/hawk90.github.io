...
전통적인 의존성 흐름과 다형성을 쓴 의존성 역전을 비교하면 다음과 같다.

![의존성 역전 전후 비교 — 화살표 방향이 뒤집힘](/images/blog/clean-architecture/diagrams/ch05-dependency-inversion.svg)
...
![플러그인 아키텍처 — 핵심 정책과 교체 가능한 디테일](/images/blog/clean-architecture/diagrams/ch05-plugin-architecture.svg)
