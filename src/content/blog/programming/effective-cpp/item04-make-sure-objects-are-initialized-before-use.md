...
- [항목 5: C++가 자동 작성하는 함수들](/blog/programming/effective-cpp/item05-know-what-functions-cpp-silently-writes) — 기본 생성자 자동 생성
- [항목 13: 자원 관리에는 객체](/blog/programming/effective-cpp/item13-use-objects-to-manage-resources) — RAII는 초기화의 한 적용
- [항목 26: 변수 정의를 가능한 늦춰라](/blog/programming/effective-cpp/item26-postpone-variable-definitions-as-long-as-possible) — 의미 있는 값을 가질 때 정의
