...
- [항목 14: 자원 관리 클래스의 복사 동작](/blog/programming/effective-cpp/item14-think-carefully-about-copying-behavior-in-resource-managing-classes) — RAII의 복사 정책
- [항목 15: 자원 관리 클래스에서 raw 자원 접근](/blog/programming/effective-cpp/item15-provide-access-to-raw-resources-in-resource-managing-classes) — `.get()` 패턴
- [항목 17: new로 만든 객체는 스마트 포인터에](/blog/programming/effective-cpp/item17-store-newed-objects-in-smart-pointers-in-standalone-statements) — 예외 안전 생성
- [항목 18: 인터페이스는 쓰기 쉽고 오용 어렵게](/blog/programming/effective-cpp/item18-make-interfaces-easy-to-use-correctly-and-hard-to-use-incorrectly) — 팩토리 반환 타입
