...
**Boost**는 동료 평가를 거친 무료 C++ 라이브러리 모음 — C++ 표준 라이브러리의 **인큐베이터**(원형) 역할을 합니다. `shared_ptr`, `regex`, `thread`, `filesystem`, `optional`, `variant`, `any` 등이 모두 Boost에서 시작해 C++11/17/20에 표준 흡수됐습니다. 표준이 빠르게 발전하면서 Boost의 자리가 줄었지만 — 여전히 **표준이 안 다루는 영역에서 가장 검증된 옵션**입니다.
...
- [항목 13: RAII](/blog/programming/effective-cpp/item13-use-objects-to-manage-resources) — Boost.SmartPtr → 표준
- [항목 47: traits 클래스](/blog/programming/effective-cpp/item47-use-traits-classes-for-information-about-types) — Boost.MPL의 원형 영역
- [항목 54: 표준 라이브러리](/blog/programming/effective-cpp/item54-familiarize-yourself-with-the-standard-library-including-tr1) — Boost가 흡수된 표준
