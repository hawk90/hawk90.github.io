...
- [항목 33: 상속된 이름 가리기 X](/blog/programming/effective-cpp/item33-avoid-hiding-inherited-names) — 인터페이스 보존
- [항목 34: 인터페이스 vs 구현 상속](/blog/programming/effective-cpp/item34-differentiate-between-inheritance-of-interface-and-inheritance-of-implementation) — virtual 종류와 계약
- [항목 38: composition](/blog/programming/effective-cpp/item38-model-has-a-or-implemented-in-terms-of-through-composition) — HAS-A의 도구
- [항목 39: private 상속](/blog/programming/effective-cpp/item39-use-private-inheritance-judiciously) — IS-IMPLEMENTED-IN-TERMS-OF
