...
- [항목 32: public 상속 = is-a](/blog/programming/effective-cpp/item32-make-sure-public-inheritance-models-is-a) — non-virtual 재정의 = LSP 위반
- [항목 33: 이름 가리기](/blog/programming/effective-cpp/item33-avoid-hiding-inherited-names) — 가림의 다른 측면
- [항목 34: 인터페이스 vs 구현 상속](/blog/programming/effective-cpp/item34-differentiate-between-inheritance-of-interface-and-inheritance-of-implementation) — 함수 종류의 의미
- [항목 37: 기본 매개변수 재정의 금지](/blog/programming/effective-cpp/item37-never-redefine-a-functions-inherited-default-parameter-value) — 또 다른 정적 바인딩 함정
