...
템플릿은 인스턴스마다 새 코드를 생성합니다 — 같은 로직이 여러 인스턴스에 중복되면 **code bloat**(코드 부풀어 오름). 매개변수에 무관한 부분을 별도 함수/클래스로 분리하면 한 번만 컴파일되어 부피 ↓. 이 항목은 세 가지 흔한 bloat 패턴과 그 해결을 다룹니다.
...
- [항목 30: inline의 이해](/blog/programming/effective-cpp/item30-understand-the-ins-and-outs-of-inlining) — 인라인과 코드 부피
- [항목 43: 템플릿 base 접근](/blog/programming/effective-cpp/item43-know-how-to-access-names-in-templatized-base-classes) — base 분리의 문법
- [항목 47: traits 클래스](/blog/programming/effective-cpp/item47-use-traits-classes-for-information-about-types) — 컴파일 타임 분기 도구
