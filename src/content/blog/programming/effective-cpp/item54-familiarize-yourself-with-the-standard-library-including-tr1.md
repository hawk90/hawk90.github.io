...
- [항목 13: RAII](/blog/programming/effective-cpp/item13-use-objects-to-manage-resources) — 표준 스마트 포인터
- [항목 47: traits 클래스](/blog/programming/effective-cpp/item47-use-traits-classes-for-information-about-types) — `<type_traits>`
- [항목 55: Boost](/blog/programming/effective-cpp/item55-familiarize-yourself-with-boost) — 표준 외 라이브러리
