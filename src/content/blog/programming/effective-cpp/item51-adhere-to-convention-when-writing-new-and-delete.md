...
`operator new`와 `operator delete`를 직접 작성하기로 했다면 — 표준이 정한 **규약**을 지켜야 합니다. 잘못된 구현은 메모리 누수, 정렬 위반, handler 미호출 등으로 이어집니다. 이 항목은 두 함수의 정확한 시그니처, 0-byte/상속/정렬 처리, 그리고 **짝 맞춤** 의무를 정리합니다.
...
- [항목 49: new-handler](/blog/programming/effective-cpp/item49-understand-the-behavior-of-the-new-handler) — handler 루프
- [항목 50: new/delete 교체 시기](/blog/programming/effective-cpp/item50-understand-when-it-makes-sense-to-replace-new-and-delete) — 정당한 사유
- [항목 52: placement delete](/blog/programming/effective-cpp/item52-write-placement-delete-if-you-write-placement-new) — placement 짝
