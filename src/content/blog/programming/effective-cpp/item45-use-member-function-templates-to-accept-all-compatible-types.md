...
- [항목 13: RAII](/blog/programming/effective-cpp/item13-use-objects-to-manage-resources) — 스마트 포인터의 동기
- [항목 41: 암묵 인터페이스](/blog/programming/effective-cpp/item41-understand-implicit-interfaces-and-compile-time-polymorphism) — generalized ctor는 컴파일 타임 검증
- [항목 46: 템플릿 안의 비-멤버 함수](/blog/programming/effective-cpp/item46-define-non-member-functions-inside-templates-when-type-conversions-are-desired) — 비-멤버 변환의 다른 면
