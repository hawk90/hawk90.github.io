...
다중 상속(MI)은 강력하지만 복잡성도 큽니다 — **ambiguity**(같은 이름 충돌), **diamond inheritance**(공통 base의 중복), **virtual base**의 비용. C++ 커뮤니티에서 "**가능하면 피하라**"는 의견이 강한 영역이지만, **추상 인터페이스 + 구현 클래스 결합** 같은 정당한 패턴도 분명히 존재합니다.
...
- [항목 32: public 상속 = is-a](/blog/programming/effective-cpp/item32-make-sure-public-inheritance-models-is-a) — 다중 IS-A의 의미
- [항목 38: composition](/blog/programming/effective-cpp/item38-model-has-a-or-implemented-in-terms-of-through-composition) — 다중 상속 회피
- [항목 39: private 상속](/blog/programming/effective-cpp/item39-use-private-inheritance-judiciously) — 정당한 다중 상속 패턴의 일부
