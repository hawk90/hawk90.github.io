...
composition — 다른 클래스의 객체를 멤버로 보유하는 관계 — 은 두 가지 의미를 가집니다:

- **어플리케이션 도메인의 has-a**: `Person`은 `Address`를 갖는다
- **구현 도메인의 is-implemented-in-terms-of**: `Set`은 `List`로 구현된다

공교롭게 둘 다 같은 C++ 문법(멤버 변수)으로 표현되지만, **의미는 다릅니다**. 상속(IS-A)과 명확히 구분해 — 이 둘 중 어느 의미인지 의식적으로 선택해야 합니다.
...
- [항목 32: public 상속 = is-a](/blog/programming/effective-cpp/item32-make-sure-public-inheritance-models-is-a) — IS-A의 조건
- [항목 39: private 상속](/blog/programming/effective-cpp/item39-use-private-inheritance-judiciously) — composition의 변형
- [항목 40: 다중 상속](/blog/programming/effective-cpp/item40-use-multiple-inheritance-judiciously) — 복합 관계
