...
좋은 인터페이스의 첫째 척도는 "사용자가 잘못 호출할 수 있는가"입니다. 주석으로 "조심하세요"라고 적는 대신 — **타입 시스템이 잘못된 호출을 컴파일 타임에 차단**하도록 설계하면 한 부류의 버그가 통째로 사라집니다. 이 항목은 그 설계 도구들 — 별도 타입, 값 범위 제한, 표준 관습 일관성, 스마트 포인터 반환 — 을 다룹니다.
...
- [항목 13: RAII](/blog/programming/effective-cpp/item13-use-objects-to-manage-resources) — 자원 반환 디자인
- [항목 19: 클래스 설계는 타입 설계](/blog/programming/effective-cpp/item19-treat-class-design-as-type-design) — 인터페이스의 시작
- [항목 23: 비-멤버 비-friend 선호](/blog/programming/effective-cpp/item23-prefer-non-member-non-friend-functions-to-member-functions) — 인터페이스 측면의 캡슐화
