...
- [항목 4: 객체 초기화](/blog/programming/effective-cpp/item04-make-sure-objects-are-initialized-before-use) — 초기치의 중요성
- [항목 21: 객체 반환은 값으로](/blog/programming/effective-cpp/item21-dont-try-to-return-a-reference-when-you-must-return-an-object) — RVO와 함께 변수 회피
- [항목 30: inline의 이해](/blog/programming/effective-cpp/item30-understand-the-ins-and-outs-of-inlining) — 최적화의 다른 측면
