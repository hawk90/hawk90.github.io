...
- [항목 8: 소멸자에서 예외가 나가지 않게](/blog/programming/effective-cpp/item08-prevent-exceptions-from-leaving-destructors) — 소멸자 본문의 규칙
- [항목 9: 생성·소멸 중 가상 함수 호출 금지](/blog/programming/effective-cpp/item09-never-call-virtual-functions-during-construction-or-destruction) — vtable 상태 함정
- [항목 32: public 상속은 is-a를 모델](/blog/programming/effective-cpp/item32-make-sure-public-inheritance-models-is-a) — 다형성의 의미
