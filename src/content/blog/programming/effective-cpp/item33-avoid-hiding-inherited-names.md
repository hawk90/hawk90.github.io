...
C++의 상속에서 **name hiding** 규칙은 직관과 다릅니다. derived 클래스에서 base와 같은 이름의 함수를 정의하면 — **시그니처가 다르더라도** — base의 모든 동명 함수가 가려집니다. 일반적인 함수 오버로딩 규칙과 정반대. `using` 선언으로 base의 이름을 명시적으로 가져와야 합니다. C++11+ 에선 생성자도 마찬가지.
...
- [항목 32: public 상속은 is-a](/blog/programming/effective-cpp/item32-make-sure-public-inheritance-models-is-a) — 인터페이스 보존
- [항목 34: 인터페이스 vs 구현 상속](/blog/programming/effective-cpp/item34-differentiate-between-inheritance-of-interface-and-inheritance-of-implementation) — 가상 함수 종류
- [항목 39: private 상속](/blog/programming/effective-cpp/item39-use-private-inheritance-judiciously) — using과의 결합
