...
- [항목 2: #define보다 const/enum/inline](/blog/programming/effective-cpp/item02-prefer-consts-enums-and-inlines-to-defines) — inline 함수 템플릿 사용
- [항목 31: 컴파일 의존성 최소화](/blog/programming/effective-cpp/item31-minimize-compilation-dependencies-between-files) — inline의 헤더 의존성 영향
- [항목 35: 가상 함수의 대안](/blog/programming/effective-cpp/item35-consider-alternatives-to-virtual-functions) — 인라인 친화적 다형성
