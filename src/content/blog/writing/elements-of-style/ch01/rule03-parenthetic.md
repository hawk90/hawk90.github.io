...
slug: "writing/elements-of-style/ch01/rule03-parenthetic"
...
문장 흐름에 *부가 정보로 끼어드는* 어구는 *양옆에* 쉼표를 둡니다. 이것이 Strunk의 핵심 원칙 중 하나입니다.
...
- [ ] 삽입 표현이 *양옆에* 쉼표가 있는가?
- [ ] *한쪽만* 쉼표를 두지 않았는가?
- [ ] 비제한적 관계절(부가 정보)에 *쉼표 있음*인가?
- [ ] 제한적 관계절(한정)에 *쉼표 없음*인가?
- [ ] 미국 영어 글에서 *which / that* 구분이 맞는가?
- [ ] 한국 글에 *번역체 삽입 표현*이 없는가?

## 다음 Rule 예고

다음 — **Rule 4: 등위 접속사 앞 쉼표**.

## 관련 항목

- [Rule 2: 직렬 쉼표](/blog/writing/elements-of-style/ch01/rule02-serial-comma)
- [Rule 4: Place a comma before a conjunction](/blog/writing/elements-of-style/ch01/rule04-conjunction)
- [Chapter 4: Words Commonly Misused](/blog/writing/elements-of-style/ch04/words-t-z) — *which / that* 추가 다루기
