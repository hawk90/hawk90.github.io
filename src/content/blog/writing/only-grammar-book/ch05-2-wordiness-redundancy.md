...
seriesOrder: 29
tags: [writing, grammar, word-usage, wordiness, conciseness]
type: book-review
...
군더더기(wordiness)는 *불필요한 단어*가 의미를 *흐리는* 현상입니다. 중복(redundancy)은 *같은 의미*가 *반복*되는 것입니다. 영어 학습자뿐 아니라 영어 화자도 자주 빠지는 함정입니다.

Strunk의 *Elements of Style* Rule 17 *"Omit needless words"*가 이 원칙의 고전적 표현입니다.
...
| in the process of | (생략 가능) |
| as a matter of fact | in fact |
| it is interesting to note that | (생략 — 다음 내용으로 바로) |
...
문장 시작에 *내용 없는 도입*을 회피.

| 회피 | 바름 |
|---|---|
| There is / There are (가능하면) | 직접 동사로 |
| It is + 형용사 + that | 직접 표현 |
...
```text
Before (62 words):
At this point in time, it is interesting to note that there are many factors
that should be given consideration when making the decision about whether
or not to implement the new policy that has been proposed by the committee
in spite of the fact that there has been a great deal of resistance from
some members of the staff.

After (20 words):
Many factors should be considered before implementing the new policy,
despite resistance from some staff members.
```
...
```text
Before (28 words):
The reason that the project failed was because of the fact that there was
a lack of proper planning and adequate resources were not made available.

After (12 words):
The project failed because of poor planning and inadequate resources.
```
...
```text
Before (24 words):
It is my personal opinion that we should give serious consideration to
the possibility of implementing this proposal in the near future.

After (11 words):
I think we should consider implementing this proposal soon.
```
...
1. 각 단어가 *의미에 기여*하는가? 빼도 의미가 같으면 빼라.
2. *동사*가 *명사화*되어 있지 않은가?
3. *Be 동사*가 동사 자리를 차지하지 않는가?
4. *수동*이 *필요한가*?
5. *There is / It is*로 시작한 문장을 *재구성*할 수 있는가?
6. *수식어*가 의미를 더하는가, 반복하는가?
...
- 좋은 글은 *필요한 단어만*
- 중복 표현 (*absolutely essential, past history, free gift*) 제거
- *명사화* (make a decision → decide) 회피
- 빈 도입어 (*There is, It is, The fact that*) 회피
- *Be 동사·Have 동사*보다 *행위 동사*
- 수동은 *필요할 때만*
- 절대 형용사 (*unique, perfect*)에 강조 어구 회피
- *In order to → to, due to the fact that → because*

## Part 5 마무리

Chapter 5 시리즈를 마칩니다. 단어 사용 — *혼동되는 단어들*과 *불필요한 단어 제거*를 다루었습니다.

마지막 Part는 **문체와 명확성(Style and Clarity)**입니다. 문법을 넘어 *좋은 글*의 원리를 다룹니다.

## 다음 장 예고

다음은 **Chapter 6: Style and Clarity** — 문법을 넘어선 문체의 원리.
