...
seriesOrder: 15
tags: [writing, academic, flow, linking, cohesion]
type: book-review
...
❷ Despite its effectiveness in counteracting sleepiness, caffeine can
   have a negative impact on subsequent sleep, which for many
   students may already be compromised.

❸ Specifically, caffeinated beverages consumed near bedtime at night
   can prolong sleep onset and reduce sleep efficiency and depth, thus
   affecting both sleep quality and duration.

❹ Most of the research on how caffeine affects sleepiness/alertness has
   focused on coffee or no-doze pills.

❺ However, a new kind of caffeinated drink has become increasingly
   popular, namely functional energy drinks (FEDs).

❻ FEDs are marketed as products that can improve both mental and
   physical performance.

❼ In addition to containing caffeine, FEDs have other active ingredients
   such as taurine, glucose, and glucoronolactone.

❽ Exactly how these ingredients together affect alertness remains
   unclear.
```
...
❺ a new kind of caffeinated drink   ← ❹의 research focus를 보완
❻ FEDs   ← ❺의 새 정보 그대로
❼ FEDs   ← ❻ 그대로
