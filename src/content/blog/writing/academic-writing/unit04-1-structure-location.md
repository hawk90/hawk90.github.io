...
seriesOrder: 41
tags: [writing, academic, data, tables, figures]
type: book-review
...
❷ As can be seen, three categories of writing strategy are reported,
   with respondents distributed unevenly across them.
...
[Discussion]
❺ Overall, the figures would appear to suggest that most Japanese
   scientists have difficulties and frustrations when preparing papers for
...
Location Statement는 두 형태로 나뉩니다.
...
As can be seen in Table 6, the overall rate of recall, while low, also
showed considerable variation.

Shallow junction GM APDs, peripheral area test structures, and gate-
controlled diodes, as shown in Figs. 1(a), 1(b), and 1(c), were
manufactured in p-type epitaxially grown bulk silicon using a
conventional 1.5 μm CMOS process reported previously.

As can be seen in Figure 1, the fully charged Lithium-ion battery
supplies 4.2 volts.
```
...
from  : As can be seen from a comparison of the two tables.
of    : As described in the introduction.
```
...
4. As defined ___ the introduction, fraud is a form of ...           → in
5. As reported ___ the previous literature, factors that ...          → in
6. As can be seen ___ a comparison of the two tables, ...            → from
7. As has been demonstrated previously ___ materials ___ this type.   → for / of
8. As has been demonstrated ___ previous studies, ...                → in / by
9. As shown ___ the line of best fit, there is no clear relationship. → by
10. As noted ___ our discussion, prolonged exposure ...               → in
```
...
Form 4: The results are shown in Table N.                ← 수동
