...
자세한 멀티스레드 디버깅은 [Ch 6](/blog/tools/gdb-lldb/chapter06-multithread-multiprocess)에서.
...
자세한 코어 덤프 분석은 [Ch 7](/blog/tools/gdb-lldb/chapter07-core-dump)에서.
...
[Ch 5: Breakpoint와 Watchpoint](/blog/tools/gdb-lldb/chapter05-breakpoints-watchpoints)에서는 *멈출 자리*를 더 깊이 다룹니다. 조건부 break의 변형, watchpoint(변수 변경 시 멈춤), hardware vs software breakpoint.
