...
[Ch 2](/blog/tools/gdb-lldb/chapter02-basic-commands)에서 `break`의 기본을 봤습니다. 이 장은 *조건부 break*, *watchpoint*, *catchpoint*, 그리고 *hardware vs software* 차이를 다룹니다.
...
[Ch 6: 멀티스레드 / 멀티프로세스](/blog/tools/gdb-lldb/chapter06-multithread-multiprocess)에서는 동시 실행 디버깅을 다룹니다. 스레드 전환, 데드락 진단, fork된 자식 따라가기.
