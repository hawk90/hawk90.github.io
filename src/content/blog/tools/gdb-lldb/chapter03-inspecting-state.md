...
[Ch 2](/blog/tools/gdb-lldb/chapter02-basic-commands)에서 `print x` 같은 기본 명령을 봤습니다. 실무에서는 *그것만으로는 부족한 자리*가 자주 등장합니다.
...
*하나씩 따라가는 게 귀찮으면* — GDB 스크립트 사용 ([Ch 9](/blog/tools/gdb-lldb/chapter09-python-scripting)).
...
[Ch 4: Backtrace와 프레임](/blog/tools/gdb-lldb/chapter04-backtrace-frames)에서는 *호출 스택*을 더 깊이 다룹니다. `bt`의 상세, 프레임 이동, inline 함수, 코어 덤프의 backtrace.
