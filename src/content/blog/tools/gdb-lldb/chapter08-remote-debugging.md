...
ptrace에 대한 자세한 동작은 [Ch 1](/blog/tools/gdb-lldb/chapter01-intro-and-install) 참고. macOS는 ptrace 대신 Mach Exception API, Windows는 `DebugActiveProcess`를 씁니다. lldb-server는 이 모든 백엔드를 통합합니다.
...
- [Ch 12: DWARF](/blog/tools/gdb-lldb/chapter12-dwarf) — 콜스택 풀기의 정체
