...
[Ch 8: Remote Debugging](/blog/tools/gdb-lldb/chapter08-remote-debugging)에서 자세히.
...
[Ch 2: 기본 명령](/blog/tools/gdb-lldb/chapter02-basic-commands)에서는 *디버거에서 매일 쓰는 명령 10개*를 자세히 다룹니다. `break`의 다양한 형태, `step` vs `next` vs `finish` 차이, `print` 포맷.
