...
CMake 3.19+에서는 *프리셋*으로 빌드 모드를 묶을 수 있습니다([Ch 9](/blog/tools/cmake/chapter09-modern-advanced#cmakepresetsjson--빌드-설정의-표준-외부화-319)).
...
- [CMake](/blog/tools/cmake/chapter01-intro) — 빌드 통합 기초
- [GNU Make](/blog/tools/gnu-make/chapter01-intro) — 더 단순한 빌드
