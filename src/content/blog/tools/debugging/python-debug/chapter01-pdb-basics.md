---
title: "Ch 1: pdb — 기본 사용법과 breakpoint() 빌트인"
...
- [Ch 2: debugpy와 IDE 통합](/blog/tools/debugging/python-debug/chapter02-debugpy-ide)
- [GDB Ch 9: Python 스크립팅](/blog/tools/gdb-lldb/chapter09-python-scripting) — GDB *안의* Python (방향이 반대)
