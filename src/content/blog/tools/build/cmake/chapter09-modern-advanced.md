...
[Ch 1](/blog/tools/cmake/chapter01-intro)~[Ch 8](/blog/tools/cmake/chapter08-best-practices)을 모두 마쳤다면 *실무에 쓸 만한 Modern CMake 프로젝트*를 만들 수 있습니다. 이 장은 *그 위에 올라가는* 고급 도구 모음입니다 — 매번 등장하진 않지만, *결정적인 자리*에서 쓰입니다.
...
- [GNU Make](/blog/tools/gnu-make/chapter01-intro) — CMake가 생성하는 빌드 파일의 기본 모델
