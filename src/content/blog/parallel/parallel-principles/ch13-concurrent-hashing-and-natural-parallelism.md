...
새 X가 자기 첫 번째 둥지로 옴
  └ 비어 있음? → 그 자리에 앉음
  └ Y가 이미 있음? → Y를 쫓아내고 X가 앉음
                  → Y는 자기 *두 번째 둥지*로 감
                  └ 거기도 차 있으면 Z가 쫓겨남
                  └ ... (체인이 길어지면 새 보금자리 찾기 포기 → 숲 확장)
```
...
```text
번호 0: 000 → 거꾸로 000 → 0번째
번호 1: 001 → 거꾸로 100 → 4번째
번호 2: 010 → 거꾸로 010 → 2번째
번호 3: 011 → 거꾸로 110 → 6번째
번호 4: 100 → 거꾸로 001 → 1번째
...

이렇게 줄세우면:
[0(00) 4(10) 2(01) 6(11) 1(00) 5(10) 3(01) 7(11)]
