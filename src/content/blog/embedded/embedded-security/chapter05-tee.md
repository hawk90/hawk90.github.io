...
slug: "embedded/embedded-security/chapter05-tee"
...
![OP-TEE 아키텍처 — Non-Secure(CA·driver) → SMC → Secure(OP-TEE OS·TA)](/images/blog/embedded-security/diagrams/ch05-optee-arch.svg)
