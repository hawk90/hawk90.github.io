...
| 관심 영역 | 추천 시리즈 |
|----------|------------|
| BLE 보안의 *암호학 깊이* | [Embedded Security](/blog/embedded/embedded-security/chapter01-threat-model) — ECC·AES·secure boot |
| RTOS 위에서 *BLE 응용 구조* | [FreeRTOS Mastering](/blog/embedded/rtos/freertos-mastering/chapter01-distribution) |
| *오늘날 양산 패턴* (OTA, BLE provisioning, secure boot) | [Modern Embedded Recipes](/blog/embedded/modern-recipes/00-preface) |
| *WiFi와 BLE 동시 운영* | [ESP32-C3 Mastering](/blog/embedded/riscv/esp32-c3-mastering/chapter01-overview) |
| MCU *전력 측정·최적화* | Embedded Performance Engineering |
...
다음 추천은 [Embedded Security](/blog/embedded/embedded-security/chapter01-threat-model) 또는 [Modern Embedded Recipes](/blog/embedded/modern-recipes/00-preface)입니다. BLE 펌웨어를 *양산*까지 끌고 가려면 *secure boot, OTA, provisioning*이 필수인데, 그 둘은 BLE 보안의 *암호학 토대*와 *오늘날 양산 패턴*을 각각 다룹니다.
...
- [Embedded Security](/blog/embedded/embedded-security/chapter01-threat-model) — 다음 추천 시리즈
- [Modern Embedded Recipes](/blog/embedded/modern-recipes/00-preface) — 다음 추천 시리즈
- [FreeRTOS Mastering](/blog/embedded/rtos/freertos-mastering/chapter01-distribution) — 다음 추천 시리즈
