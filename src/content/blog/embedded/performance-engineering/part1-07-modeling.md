...
병렬화로 *90ms → 0ms* (S=∞)가 되어도 다음과 같습니다.
...
- α가 큰 시스템은 적은 코어에서 plateau에 도달합니다.
- β가 큰 시스템은 적정 코어 수를 넘으면 *역효과 (negative scalability)*가 발생합니다.
...
- **Amdahl**: 1 / ((1-P) + P/S) — serial 부분이 한계가 됩니다.
