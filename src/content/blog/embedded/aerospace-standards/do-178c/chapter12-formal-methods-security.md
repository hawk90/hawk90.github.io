...
slug: "embedded/aerospace-standards/do-178c/chapter12-formal-methods-security"
...
| Obj | Traditional | Formal |
|-----|-------------|--------|
| A-5-1 (Code ↔ LLR consistency) | Code review + test | Code의 spec이 LLR과 일치함을 prove |
| A-5-4 (Code accuracy + consistency) | Test + static analysis | Runtime error 부재 증명 (Astrée) |
| A-6-1/2 (HLR/LLR test coverage) | Test cases for all req | Spec coverage + proof |
| A-7-5 (Structural coverage analysis) | MC/DC | 모든 paths를 spec이 cover |
...
| Phase | 기간 | 활동 |
|-------|------|------|
| 1. 개념 | 1–3 months | 이 시리즈 12장 정독 · RTCA DO-178C 책 (필수, $200) · FAA AC 20-115D 읽기 |
| 2. 도구 | 3–6 months | LDRA Testbed 또는 VectorCAST trial · Polyspace Bug Finder + Code Prover · DOORS 기본 사용 |
| 3. 적용 | 6–12 months | 작은 DAL D 프로젝트 참여 · PSAC, SDP 같이 작성 · SOI 1 review 옵저버 |
| 4. 심화 | 1–3 years | DAL B/A 프로젝트 · Verification 또는 Certification 전문 · SOI review 진행 |
| 5. 전문가 | 5+ years | 새 프로젝트 PSAC lead · FAA DER 자격 (미국) · 한국 KAA DER 자격 · International consultant |
