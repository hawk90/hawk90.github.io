...
한국에 *KAI, Korean Air, KARI, LIG Nex1, Hanwha Aerospace* 등 *항공·우주 SW 적용 기업·기관*이 다수. 각 회사의 *정확한 mission별 DO-178C 적용 범위, 인력, 도구 stack*은 *비공개* 또는 *회사 공식 발표 한정*. 이 시리즈는 *내부 정보 추정 제시 안 함*.

특히 *수출용 무기·항공기*는 *DO-178C 인증*이 *국제 시장 진입 조건*인 경우가 일반적.
...
재정     :  코드 line당 인증 비용이 *상당* — 정확한 수치는 프로그램별 비공개·추정
```
...
- Large system, DAL A   : 5~10+ year

## 비용 — 일반 관찰

DO-178C 인증 비용은 *DAL과 시스템 규모에 비례*. *DAL A의 대형 시스템*은 *수년 + 수천만 달러*에 이르는 것으로 산업 통념상 자주 언급된다. 정확한 *프로그램별 비용*은 *대부분 비공개*이므로 *vendor / 프로그램 공식 발표*가 있는 경우만 인용.
...
한국 항공·우주 회사가 *FAA / EASA 인증 mission*에 참여할 때는 *수입국 인증* 또는 *FAA 인증서 참조* 같은 절차를 거친다. 군용 mission은 *국방규격 (KDS, KMS)*이 별도 적용. 정확한 *각 프로그램 인증 procedure*는 *해당 기관·회사 발표* 참조.
...
- 국내 적용: 항공·우주 기업·기관 다수. *내부 mission별 적용 범위는 비공개 / 공식 발표 한정*.
- 인증 비용: *DAL과 규모에 비례*. 정확한 수치는 *프로그램별 비공개 / 추정*.
