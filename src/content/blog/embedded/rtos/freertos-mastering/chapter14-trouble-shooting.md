...
- [Practical RTOS Internals](/blog/embedded/rtos/practical-internals/) — *FreeRTOS의 스케줄러·MPU·SMP가 어떻게 동작하는지* 소스 레벨로. v11 SMP의 구현, low-power tick 보정의 코너 케이스, MPU wrapper의 SVC 진입까지 한 줄씩 따라가는 시리즈.
...
- [Modern Embedded Recipes](/blog/embedded/modern-recipes/) — DMA + ring buffer, 한 줄 로깅 큐, watchdog 패턴 등 *실전에서 매번 마주치는 레시피 모음*.

## 관련 항목

- [Ch 1: Introduction](/blog/embedded/rtos/freertos-mastering/chapter01-introduction)
