...
slug: "embedded/rtos/practical-internals/part5-07-preempt-rt-linux"
...
| 구성 | IRQ latency 평균 | worst case |
|---|---|---|
| Mainline Linux (PREEMPT) | 10-50 µs | 수 ms |
| PREEMPT_RT (Cortex-A53 튜닝) | 5-15 µs | 100-300 µs |
| RTOS (Cortex-M4 FreeRTOS) | 80-100 ns | 수 µs |
...
"PREEMPT_RT는 µs 보장"이라 가정하고 ABS·airbag에 적용하면 worst case 100-300 µs로 safety budget을 초과합니다.
