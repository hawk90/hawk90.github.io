...
Source가 안 보임 → Derived. Example: "Buffer size shall be 4096 byte" — System level에 없는 implementation choice.
...
**Coverage** — All req → impl + test. No orphan code (req 없는 코드).
...
**Korea** — 방사청·KARI: DOORS 표준 + 일부 internal tool.
...
- **Requirements-based test** — 각 HLR·LLR → test case. 100% HLR·LLR coverage. Normal range + robustness.
- **Structural coverage test** — Source code coverage (8장).
...
- **Validation** — "Right requirements" 확인. Stakeholder·system engineering review.
- **Verification** — "Requirements met" 확인. Test·analysis·review.
