...
대역폭 밀도 (Tbps/mm²)
   ▲
10 │                                    ● UCIe Advanced (Si interposer, 25μm)
   │
 8 │
   │
 6 │                       ● UCIe Standard (Si bridge, 45μm)
   │
 4 │
   │
 2 │       ● BoW Standard (100μm)
   │   ● BoW Flexi (130μm, organic)
 1 │
   └────┬──────┬─────────┬──────────────────►
       130    100        45             25     bump pitch (μm)
       organic           Si bridge      Si interposer
```
...
├── 사양
│   ├── BoW 1.0 (2020)         ← 초기 발표
│   ├── BoW 2.0 (2022)         ← Flexi/Memory 변형 추가
│   └── BoW Memory (ongoing)
├── PHY IP
│   ├── Synopsys DesignWare BoW PHY
│   ├── Cadence BoW IP
│   └── Marvell Tahoe (사내 PHY)
├── 패키징
│   ├── Samsung Foundry I-Cube (silicon bridge)
│   ├── TSMC InFO/LSI
│   └── ASE organic substrate
└── 검증 도구
