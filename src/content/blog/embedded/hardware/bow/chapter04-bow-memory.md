...
이 구성의 장점은 *CXL 생태계의 software stack을 그대로* 쓸 수 있다는 점입니다. 호스트 입장에서는 BoW든 PCIe든 *동일한 CXL 메모리*로 보입니다. 자세한 CXL 동작은 [CXL Ch 2](/blog/embedded/hardware/cxl/chapter02-system-architecture)를 참고하면 좋습니다.
...
- [CXL Ch 1: 개요](/blog/embedded/hardware/cxl/chapter01-cxl-position)
- [CXL Ch 2: Protocol](/blog/embedded/hardware/cxl/chapter02-system-architecture)
