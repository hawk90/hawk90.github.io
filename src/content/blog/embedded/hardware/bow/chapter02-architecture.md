...
![Slice 단방향 구성 — 16 data lane, fwd_clk, sideband](/images/blog/hardware/bow/diagrams/ch02-slice.svg)
...
![Source-synchronous — TX가 data와 fwd_clk을 함께 송신](/images/blog/hardware/bow/diagrams/ch02-fwd-clock.svg)
...
![Per-lane deskew — fwd_clk 기준으로 각 lane을 ±1 UI 안으로 정렬](/images/blog/hardware/bow/diagrams/ch02-deskew.svg)
...
![8 Slice 병렬 구성 — Slice 간 word alignment](/images/blog/hardware/bow/diagrams/ch02-slice-parallel.svg)
...
실제 구성 예 (16 active + 2 redundant)는 다음과 같습니다.

| lane | 역할 | 비고 |
|------|------|------|
| lane 0~15 | active | 정상 동작 시 데이터 송수신 |
...
![BoW Slice PHY 블록 다이어그램 — App, Word formatter, SerDes, Clock, Sideband](/images/blog/hardware/bow/diagrams/ch02-phy-block.svg)
