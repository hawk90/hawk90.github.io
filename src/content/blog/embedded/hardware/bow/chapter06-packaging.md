...
2. probing card는 microbump pitch를 따라가기 어려움 (130 μm는 가능, 25 μm는 거의 불가능)
...
- [CXL 시리즈](/blog/embedded/hardware/cxl/chapter01-cxl-position) — 코히어런트 인터커넥트. BoW Memory 위에 얹히는 *대표 protocol*입니다.
