...
│                                         │
│ ┌─────────────────────────────────────┐ │
│ │  silicon interposer (full Si layer) │ │
...
```text
Slice 하나의 bump 요구 (대략)
- 16 data lane × 1 bump = 16
- 1 fwd clock × 1 bump = 1
- 2~4 sideband × 1 bump = 2~4
- power/ground = ~16 (data lane 1개당 1 GND 권장)
