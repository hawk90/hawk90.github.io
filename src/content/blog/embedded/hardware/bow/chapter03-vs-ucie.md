...
패키지 단가는 packaging 기술에 따라 한 자릿수씩 차이가 납니다 (100 mm² die 기준 대략값).
...
| 표준 | shoreline density |
|------|--------------------|
| BoW Flexi | ~0.3 Tbps/mm |
| BoW Standard | ~0.6 Tbps/mm |
| UCIe Standard | ~1.5 Tbps/mm |
| UCIe Advanced | ~3.0 Tbps/mm |
...
![UCIe vs BoW protocol stack — UCIe는 3 layer 모두 표준, BoW는 PHY만 표준](/images/blog/hardware/bow/diagrams/ch03-protocol-stack.svg)
...
![D2D 대역폭 기준 결정 트리 — < 500 GB/s → BoW Flexi/Standard, 500 GB/s~2 TB/s → BoW Standard 또는 UCIe Standard (외부 인증 vs 비용), > 2 TB/s → UCIe Advanced](/images/blog/hardware/bow/diagrams/ch03-bandwidth-decision-tree.svg)
