...
GDDR6 chip 단면
   ...
   │   └──────────────────────┘       │
   └──────────────────────────────────┘
       BGA package (180-ball)
       표준 footprint 14 × 12 mm
```
...
PAM3 신호 (3-level)
  ...
  Voltage
   ...
   3-level × 1 UI에 1.5 bit 인코딩
   실제로는 8 ternary symbol → 12 bit 매핑
```
...
```text
GDDR6X 384-bit PCB layout (RTX 4090 기준)

   ┌──────────────────────────────────────┐
   │                                      │
   │    ┌──┐ ┌──┐ ┌──┐                    │
   │    │M0│ │M1│ │M2│                    │   GDDR6X chip
   │    └──┘ └──┘ └──┘                    │
   │   ╱╲ ╱╲ ╱╲                           │
   │  ╱  ╲╱  ╲╱  ╲    ═══ ═══ ═══         │
   ...
   length matching tolerance: ±0.5 mm (PAM4)
   PCB layer 수: 10~12 (PAM4)
   임피던스: 40 Ω ±5%
```
