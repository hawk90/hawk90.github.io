...
const en: typeof ko = defineLocale({
  ...
  search_no_results_hint: 'Try a different spelling or another wording.',
  search_clear_filter: 'Search again without the filter',
  search_browse_paths: 'Browse learning paths',
  search_browse_archive: 'Browse all posts',
