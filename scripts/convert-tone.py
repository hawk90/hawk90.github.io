...
# Tone A → B. '합니다'는 한다(동사)/하다(형용사) 모호 → 제외(수동). 명확한 것만.
MAP_A_TO_B = [
    ("됩니다", "된다"), ("입니다", "이다"), ("있습니다", "있다"), ("없습니다", "없다"),
    ("같습니다", "같다"), ("집니다", "진다"), ("납니다", "난다"), ("듭니다", "든다"),
    ("칩니다", "친다"), ("봅니다", "본다"), ("옵니다", "온다"), ("씁니다", "쓴다"),
    ("갑니다", "간다"), ("냅니다", "낸다"), ("줍니다", "준다"), ("웁니다", "운다"),
    ("뭅니다", "문다"), ("켭니다", "켠다"),
    ("쉽습니다", "쉽다"), ("어렵습니다", "어렵다"), ("좋습니다", "좋다"),
    ("많습니다", "많다"), ("적습니다", "적다"), ("큽니다", "크다"), ("작습니다", "작다"),
    ("높습니다", "높다"), ("낮습니다", "낮다"), ("짧습니다", "짧다"),
    ("았습니다", "았다"), ("었습니다", "었다"), ("였습니다", "였다"), ("했습니다", "했다"),
    ("됐습니다", "됐다"), ("봤습니다", "봤다"), ("왔습니다", "왔다"), ("갔습니다", "갔다"),
    ("났습니다", "났다"), ("웠습니다", "웠다"), ("줬습니다", "줬다"),
]
...
def main():
    ...
    ap.add_argument("--to", choices=["A", "B"], default="A",
                    help="A=~합니다, B=~다 (B는 '합니다' 모호형 제외, 수동 보정)")
    ap.add_argument("--apply", action="store_true")
    args = ap.parse_args()
    mapping = MAP_B_TO_A if args.to == "A" else MAP_A_TO_B
